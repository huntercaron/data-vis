...
export default function (sketch) {
  ...
  function drawLeaf(call) {
    ...
    sketch.stroke(sketch.map(call.length, 1, maxLength, 79, 35), sketch.map(call.length, 1, maxLength, 104, 200), sketch.map(call.length, 1, maxLength, 250, 100), sketch.map(call.length, 1, maxLength, 50, 100));
    sketch.fill(sketch.map(call.length, 1, maxLength, 79, 35), sketch.map(call.length, 1, maxLength, 104, 200), sketch.map(call.length, 1, maxLength, 250, 100), 10);
